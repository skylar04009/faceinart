...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        for si, pred in enumerate(out):
            ...
            if save_txt:
                ...
                for *xyxy, conf, cls in predn.tolist():
                    ...
                    with open(save_dir / 'label' / (path.stem + '.txt'), 'a') as f:
            ...
            if nl:
                ...
                scale_coords(img[si].shape[1:], tbox, shapes[si][0], shapes[si][1])  # native-space label
                if plots:
        ...
        if plots and batch_i < 3:
            f = save_dir / f'test_batch{batch_i}_labels.jpg'  # label
